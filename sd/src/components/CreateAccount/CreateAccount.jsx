...
import { Icons24PxBlackBasket } from "../../icons/Icons24PxBlackBasket";
import "./style.css";
  ...
  return (
    <div className="create-account">
        ...
        <div className="overlap">
          ...
          <div className="i-AGREE-WITH">
            <div className="object-wrapper">
              <img className="object" alt="Object" src="/img/object-6.png" />
            </div>
          ...
          <div className="PASSWORD">
            <div className="overlap-group-wrapper">
              <div className="overlap-group-2">
                ...
                <img className="img" alt="Object" src="/img/object-4.png" />
              </div>
            </div>
          </div>
          <div className="EMAIL">
          ...
          <div className="NAME">
            <div className="overlap-group-wrapper">
              <div className="overlap-group-2">
                ...
                <img className="object-2" alt="Object" src="/img/object.png" />
              </div>
            </div>
          </div>
      ...
      <div className="navigation">
        ...
        <Icons24PxBlackBasket className="icons-black" color="white" />
