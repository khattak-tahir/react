...
export const Settings = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setCaptionIndex((prevIndex) => (prevIndex === captions.length - 1 ? 0 : prevIndex + 1));
    }, 1500);
  ...
  return (
    <ScrollView style={[styles.container, darkMode && styles.darkModeContainer]}>
      ...
      <View style={[styles.settingsContainer, darkMode && styles.darkModeSettings]}>
        <View style={[styles.settingsContainer1, darkMode && styles.darkModeSettings]}>
        <View style={styles.setting}>
        <View style={styles.settingIcon}>
            <Icon name="user" size={20} color={darkMode ? 'white' : '#1a8739'} /> 
        ...
        <View style={styles.setting}>
        <View style={styles.settingIcon}>
            <Icon name="envelope" size={20} color={darkMode ? 'white' : '#1a8739'} /> 
          <Text style={[styles.settingLabel, darkMode && styles.darkModeText]}>Support Email</Text>
        </View>
        <TouchableOpacity onPress={handleSupportEmailPress}>
        <View style={styles.settingValueContainer}>
          <Text style={styles.settingValue}>tahirkhattak456@gmail.com</Text>
        ...
        <View style={styles.setting}>
          <View style={styles.settingValueContainer1}>
            ...
            <Text style={[styles.settingLabel, !darkMode && { color: 'black' }]}>Dark mode</Text>
        ...
        <View style={styles.setting}>
        <View style={styles.settingIcon}>
            <Icon name="info-circle" size={20} color={darkMode ? 'white' : '#1a8739'} /> 
          <Text style={[styles.settingLabel, darkMode && styles.darkModeText]}>About Us</Text>
          </View>
          <View style={styles.settingValueContainer}>
